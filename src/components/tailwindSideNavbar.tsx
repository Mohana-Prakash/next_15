...
export default function TailwindSideNavbar({ children }: Readonly<Props>) {
  let menu_arr = [
    "Dashboard",
    "Inbox",
    "Users",
  ...
  return (
    <>
      <nav className="fixed top-0 z-50 w-full bg-white border-b border-gray-200 dark:bg-gray-800 dark:border-gray-700 shadow-md">
        <div className="px-3 py-1 lg:px-5 lg:pl-3">
          <div className="flex items-center justify-between">
            <div className="flex items-center rtl:justify-end w-2/4">
              <button
                ...
                <div
                  ...
                  <div className="px-4 py-3" role="none">
                    <p
                      ...
                      role="none">
                      Welcome..! <b>Intelligrid</b>
                    </p>
                    <p
                      className="text-sm font-medium text-gray-900 truncate dark:text-gray-300"
                      role="none">
                      superadmin@intellgrid.ai
                    </p>
                  </div>
      ...
      <div className="p-4 sm:ml-64 min-h-screen bg-white">
        <div className="p-0 sm:p-4 mt-14 text-gray-700">{children}</div>
      </div>
    </>
  );
}
